...
class DenseNet(nn.Module):
    def __init__(self,n_class,save_features=False, bench_model=False):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(3,64,kernel_size=3),
                                   nn.BatchNorm2d(64),
                                   nn.ReLU())
        self.conv2 = nn.Sequential(nn.Conv2d(64,64,kernel_size=3,stride=2),
                                   nn.BatchNorm2d(64),
                                   nn.ReLU())
        self.conv3 = nn.Sequential(nn.Conv2d(64,128,kernel_size=3),nn.BatchNorm2d(128),
                                   nn.ReLU())
        self.conv4 = nn.Sequential(nn.Conv2d(128,128,kernel_size=3,stride=2),
                                   nn.BatchNorm2d(128),nn.ReLU())

        self.conv5 = nn.Sequential(nn.Conv2d(128, 256, kernel_size=3,stride=2),
                                   nn.BatchNorm2d(256), nn.ReLU())

        self.conv6 = nn.Sequential(nn.Conv2d(256, 256, kernel_size=1),
                                   nn.BatchNorm2d(256), nn.ReLU())

        self.pool = nn.AdaptiveAvgPool2d(1)
        self.classifier = nn.Linear(256,self.n_class)
